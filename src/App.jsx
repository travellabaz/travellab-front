...
function localeRouteChildren() {
  return [
    ...
    // Same EventsPage handles both — it decides internally (by phone
    ...
    <Route key="korporativ" path="korporativ" element={<KorporativPage />} />,
    <Route key="endirimler" path="endirimler" element={<EndirimlerPage />} />,
